<h3>Hello Team!</h3>
<p>A new Hospital Accreditation Form has been successfully submitted through the website. Please review the details below.</p>

<p><strong>Hospital / Business Details:</strong></p>

<p><strong>Hospital Name:</strong> {{ $data['name'] }}<br>
